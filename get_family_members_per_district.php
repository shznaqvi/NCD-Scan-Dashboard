...
$query = "SELECT districtName, count(*) AS familyMemberCount FROM familymember f left join district d on f.distCode = d.districtCode where districtname is not null GROUP BY distCode";
