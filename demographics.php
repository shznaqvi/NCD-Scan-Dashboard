...
$.ajax({
    type: 'GET',
    url: 'get_gender_count.php', // Replace with the actual URL
    dataType: 'json',
...
$.ajax({
    type: 'GET',
    url: 'get_education_status.php', // Replace with the actual URL
    dataType: 'json',
    success: function(response) {
...
$.ajax({
    type: 'GET',
    url: 'get_employment_status.php', // Replace with the actual URL
    dataType: 'json',
    success: function(response) {
        var employedCount = 0;
