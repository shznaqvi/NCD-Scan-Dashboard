...
<div class="container">
  <div class="row justify-content-center ">
    <div class="col-xxl-4 col-xl-5 col-lg-6 col-md-8">
			...
			<div class="pt-4 pb-4 text-center card-primary-color card-header"><a href="/"><span><img 
			src=".\i\wellness_health_care.png" 
			alt="" height="48"></span></a></div>
                <div class="card-body p-5 bg-light rounded-3 ">
				                    <div class="alert alert-danger" id="errorAlert" style="display: none;"></div>

<div class="text-center w-75 m-auto"><h4 class="text-dark-50 text-center mt-0 fw-bold">Sign In</h4><p class="text-muted mb-4">Enter your username and password to access admin panel.</p></div>    
